...
from chainercmd.config.evaluator_creator import get_evaluator_creator_from_config  # NOQA
from chainercmd.config.extension import get_custum_extension_from_config  # NOQA
